...
/// Adding the cruise type
/// Changing ``Trip.fathoms`` to double
/// Adding ``Sounding.id`` as a UUID
enum TripSchemaV15: VersionedSchema {
    static var versionIdentifier = Schema.Version(2, 3, 2)
    ...
    @Model final class Cruise {
        ...
        init(id: UUID, _anchorages: Data? = nil, _start: Date, forecastFetched: Date? = nil, _colours: String, _weather: Data? = nil, trips: [Trip]? = nil) {
