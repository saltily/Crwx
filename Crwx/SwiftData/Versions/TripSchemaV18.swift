...
/// Very similar to V17 but also adding a web id to harbours for sharing online.
enum TripSchemaV18: VersionedSchema {
    static var versionIdentifier = Schema.Version(2, 3, 5)
