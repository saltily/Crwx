...
/// I'm finding the Cruising Guide is too much for a single notes field, so I want to expand that.
enum TripSchemaV11: VersionedSchema {
    static var versionIdentifier = Schema.Version(2, 2, 2)
