...
/// Add imported routes, tracks, and waypoints
enum TripSchemaV5: VersionedSchema {
    ...
    @Model final class Route {
        ...
        init(name: String, _waypoints: Data? = nil, length: Double, created: Date, imported: Date, endpointNames: String, endpointIds: String) {
            self.name = name
    ...
    @Model final class Waypoint {
        ...
        var created: Date = Date.now
        var imported: Date = Date.now
        init(latitude: Double, longitude: Double, name: String, _symbol: String? = nil, created: Date, imported: Date) {
    ...
    @Model final class Track {
        ...
        var imported: Date = Date.now
        var source: String = ""
        init(name: String, date: Date? = nil, _points: Data? = nil, imported: Date, source: String) {
            self.name = name
            self.date = date
