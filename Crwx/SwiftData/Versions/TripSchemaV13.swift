...
/// We're gonna start tracking soundings for water, propane, ice box temperature, and how many fathoms for anchoring.
/// See ``Sounding`` and ``Trip.overnightDepths`` and ``Trip.fathoms``
enum TripSchemaV13: VersionedSchema {
