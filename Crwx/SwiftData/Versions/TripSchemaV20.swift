...
//  Mewx
//
//  Created by Matthew Goacher on 9/15/25.
//
...
/// Connect photos to harbours
public enum TripSchemaV20: VersionedSchema {
    public static var versionIdentifier = Schema.Version(2, 3, 7)
    ...
    @Model final class Photo {
        ...
        var uploaded: Date?
        init(id: UUID, webId: Int? = nil, date: Date, data: Data? = nil, latitude: Double? = nil, longitude: Double? = nil, photographer: String, comments: String, isVideo: Bool, originalWidth: Int, originalHeight: Int, uploaded: Date? = nil, trip: Trip? = nil) {
            self.id = id
            self.webId = webId
            self.date = date
            self.data = data
        ...
        @Relationship(inverse: \Trip.photos) var trip: Trip?
        @Relationship(inverse: \Harbour.photos) var harbour: Harbour?
    }
    ...
    @Model public final class LocationProfile {
        ...
        var _tides: Data?
        var _currents: Data?
        init(id: UUID, name: String, index: Int, latitude: Double, longitude: Double, observations: String, marineLatitude: Double, marineLongitude: Double, _zone: Data? = nil, _buoy: Data? = nil, _tides: Data? = nil, _currents: Data? = nil) {
            self.id = id
            self.name = name
            self.index = index
            self.latitude = latitude
